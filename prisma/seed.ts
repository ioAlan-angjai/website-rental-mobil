...
async function main() {
  ...
  const cars = [
    ...
    },
    {
      ...
      features: JSON.stringify(['Bodykit GR Sport', 'Paddle Shift', '7 Airbags', 'Rear Camera']),
      status: 'AVAILABLE',
      description: 'Hatchback sporty dengan handling presisi dan tampilan modern berjiwa muda.',
    },
    {
    ...
    {
      name: 'Toyota Alphard 2.5 G Luxury',
      brand: 'Toyota',
      category: 'Luxury',
      year: 2023,
      transmission: 'Otomatis',
      ...
      features: JSON.stringify(['Executive Lounge', 'Dual Sunroof', 'JBL Sound System', 'Ottoman Seats']),
      status: 'AVAILABLE',
      description: 'Kendaraan luxury VIP kasta tertinggi untuk tamu kehormatan, VIP corporate, dan event pernikahan eksklusif.',
    },
    {
      name: 'Daihatsu Gran Max Pickup 1.5',
      brand: 'Daihatsu',
      category: 'Pickup',
      year: 2022,
      transmission: 'Manual',
      ...
      pricePerDay: 275000,
      images: JSON.stringify([
        'https://images.unsplash.com/photo-1586191582150-f86a7d576a44?w=800&auto=format&fit=crop&q=80',
      ]),
      features: JSON.stringify(['Bak Luas 3-Way', 'Mesin 1.5L VVT-i', 'Daya Angkut 1 Ton', 'AC Dingin']),
      status: 'AVAILABLE',
      description: 'Mobil niaga angkut barang tangguh dan efisien untuk keperluan pindahan, event logistik, dan bisnis.',
    },
    {
